  ...
  def self.available
    {
      ...
      'ublinvoice_20' => { :format=>'peppolubl20',      :channel=>'free_ubl',    :validate=>[:client_has_email, :ubl_invoice_has_no_taxes_withheld] },
      'biiublinvoice_20' => { :format=>'biiubl20',      :channel=>'free_ubl',    :validate=>[:client_has_email, :ubl_invoice_has_no_taxes_withheld] },
      ...
      'peppol'        => { :format=>'peppolubl20', :channel=>'free_peppol', :private=>true, :validate=>[:ubl_invoice_has_no_taxes_withheld, :peppol_fields] },
      'peppolbii'     => { :format=>'biiubl20',    :channel=>'free_peppol', :private=>true, :validate=>[:ubl_invoice_has_no_taxes_withheld, :peppol_fields] },
      'svefaktura'    => { :format=>'svefaktura',  :channel=>'free_svefaktura', :private=>true, :validate=>[:ubl_invoice_has_no_taxes_withheld, :svefaktura_fields] }
    }
  end
